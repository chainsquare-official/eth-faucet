...
var (
	...
	proxyCntFlag = flag.Int("proxycount", 5, "Count of reverse proxies in front of the server")
	...
	intervalFlag = flag.Int("faucet.minutes", 30, "Number of minutes to wait between funding rounds")
